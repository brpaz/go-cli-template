  ...
  outputs = { self, nixpkgs }:
    ...
    in
    {
      ...
      packages = forAllSystems (system:
        ...
        in
        {
          go-cli-template = pkgs.buildGoModule {
            pname = "go-cli-template";
            inherit version;
            ...
            postInstall = ''
              mv $out/bin/cmd $out/bin/go-cli-template
            '';
      ...
      # package.
      defaultPackage = forAllSystems (system: self.packages.${system}.go-cli-template);
    };
}
